...
@section('content_header')
    ...
    <small>(Para eliminar un proyecto, primero se deben eliminar sus imágenes)</small>
@stop
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th scope="col">Imágenes agregadas</th>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <a href="{{ route('project.edit', $project) }}" type="button" class="btn btn-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10px" fill="none" viewBox="0 0 24 24"
                                    stroke="#FFF">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                </svg>
                            </a>
                            <a href="{{ route('images.index', $project) }}" type="button" class="btn btn-primary">
                            ...
                            <form class="inline-block" action="{{ route('project.destroy', $project) }}" method="POST">
                                ...
                                <button class="btn btn-danger" type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10px" fill="none"
