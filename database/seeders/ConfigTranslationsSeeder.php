...
class ConfigTranslationsSeeder extends Seeder
{
    ...
    public function run()
    {
        $data_translations = [
            ...
            'about_us_description' => '
            <p>English MS Ingeniería Diseño y Construcción fue fundada en el año 2016 por el ingeniero en construcción Marco Salas, quien inició sus labores profesionales en infraestructura para desarrollos turísticos y habitacionales. Luego se trasladó a Panamá donde estuvo por más de 8 años realizando trabajos en proyectos de generación de energía. MS tiene operación en Costa Rica Y Panamá. Gracias a la amplia experiencia de nuestro fundador, realizamos en Panamá trabajos de mantenimiento de hidroeléctricas.&nbsp;</p><p>En Costa Rica por otro lado, nos dedicamos al diseño y construcción de proyectos habitacionales y comercio, siempre con el afán de ayudar a nuestros clientes a realizar sus sueños de forma fácil y exitosa. Para nosotros nuestro trabajo significa: compromiso, calidad, innovación, honestidad, trabajo en equipo y sobre todo, servicio al cliente.</p>
            ',
            ]
        ];
